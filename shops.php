...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $search_sql = 'SELECT * FROM coffee_shops WHERE ShopName LIKE :search';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    isset($_POST['WebsiteURL']) && isset($_POST['AverageRating']) && isset($_POST['RoasteryID'])
        ...
        $insert_sql = 'INSERT INTO coffee_shops (ShopName, Address, City, State, ZipCode, ContactInfo, WebsiteURL, AverageRating, RoasteryID) 
        ...
        $delete_sql = 'DELETE FROM coffee_shops WHERE ShopID = :id';
